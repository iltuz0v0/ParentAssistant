...
public class CustomNotificationManager {
    ...
    public void createRequestNotification(NotificationManager manager,
                                          int id, int type, Activity context){
        Notification.Builder builder = new Notification.Builder(context);
        builder.setContentTitle(context.getResources()
                .getString(R.string.notification_request_title));
        builder.setContentText(context.getResources()
                .getString(R.string.notification_request_text));
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,
                notificationRequestCode, intent, PendingIntent.FLAG_NO_CREATE);
