...
public class SharedPreferenceManager {
    ...
    public static void getGoogleIdentifier(InputAccount account, Context context) {
        ...
        String googleIdentifier = preferences.getString(context
                .getString(R.string.google_identifier), NO_GOOGLE_IDENTIFIER);
    ...
    public static boolean saveGoogleIdentifier(Context context,
                                            GoogleSignInAccount account){
        SharedPreferences sharedPreferences = context
                .getSharedPreferences(context.getResources()
                                .getString(R.string.network_data_file),
                        Context.MODE_PRIVATE);
        int result = sharedPreferences.getInt(context.getString(R.string.google_identifier), -1);
        SharedPreferences.Editor preferences =
                context.getSharedPreferences(context.getResources()
                                .getString(R.string.network_data_file),
                        Context.MODE_PRIVATE).edit();
        preferences.putString(context.getString(R.string.google_identifier),
                account.getId());
        preferences.apply();
        return result != -1;
    }
